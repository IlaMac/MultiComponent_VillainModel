                    ...
                    for (beta = 0; beta < NC; beta++) {
                        ...
                        for (vec = 0; vec < 3; vec++) {
                            ...
                            if(beta==alpha){
                                ...
                                new_int_phase[beta]= Site[i].Psi[beta].t/dp;
                            }
                            arg_F_new[beta][vec] = //ARG( (Site[ip].Psi[beta].t*inv_dp - new_int_phase[beta]), MaxP);
                                    arg( (Site[ip].Psi[beta].t/dp - new_int_phase[beta]));
