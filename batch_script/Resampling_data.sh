...
#BASEDIR="/home/ilaria/Desktop/MultiComponent_VillainModel/Output_Villain_2C/e_${H_e}/nu_${H_nu}/h_${H_h}"


for L in $LList; do
    DIRECTORY=$BASEDIR/L${L}_rho${H_rho}_eta1${H_eta1}_eta2${H_eta2}_e${H_e}_h${H_h}_nu${H_nu}_bmin${H_blow}_bmax${H_bhigh}_nMAX${nMAX}_init${H_init}
...
python3 New_Bootstrap_Energy.py ${BASEDIR} ${H_blow} ${H_bhigh} ${nbeta} ${H_e} ${H_h} ${H_nu} ${H_eta1} ${H_eta2} ${H_rho} ${nMAX} ${H_init} ${flag} ${LList[@]}
python3 New_Bootstrap_HelicityModulus.py ${BASEDIR} ${H_blow} ${H_bhigh} ${nbeta} ${H_e} ${H_h} ${H_nu} ${H_eta1} ${H_eta2} ${H_rho} ${nMAX}  ${H_init} ${flag} ${LList[@]}
python3 New_Bootstrap_Magnetization.py ${BASEDIR} ${H_blow} ${H_bhigh} ${nbeta} ${H_e} ${H_h} ${H_nu} ${H_eta1} ${H_eta2} ${H_rho} ${nMAX} ${H_init} ${flag} ${LList[@]}
